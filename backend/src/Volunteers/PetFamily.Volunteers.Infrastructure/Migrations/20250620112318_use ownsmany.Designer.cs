...
namespace PetFamily.Volunteers.Infrastructure.Migrations
{
    ...
    [Migration("20250620112318_use ownsmany")]
    partial class useownsmany
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PetFamily.Volunteers.Domain.Entities.Pet", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Birthday", "PetFamily.Volunteers.Domain.Entities.Pet.Birthday#Birthday", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("CreationDate", "PetFamily.Volunteers.Domain.Entities.Pet.CreationDate#CreationDate", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("HealthInformation", "PetFamily.Volunteers.Domain.Entities.Pet.HealthInformation#HealthInformation", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("IsSterilized", "PetFamily.Volunteers.Domain.Entities.Pet.IsSterilized#IsSterilized", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("MainPhoto", "PetFamily.Volunteers.Domain.Entities.Pet.MainPhoto#MainPhoto", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("NickName", "PetFamily.Volunteers.Domain.Entities.Pet.NickName#NickName", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("OwnerPhoneNumber", "PetFamily.Volunteers.Domain.Entities.Pet.OwnerPhoneNumber#PhoneNumber", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("PetStatus", "PetFamily.Volunteers.Domain.Entities.Pet.PetStatus#PetStatus", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("PetFamily.Volunteers.Domain.Entities.Pet", b =>
                {
                    ...
                    b.OwnsMany("PetFamily.Volunteers.Domain.SharedVO.Details", "DetailsList", b1 =>
                        {
                            ...
                            b1.ToTable("pets", "pet_management");

                            b1.ToJson("DetailsList");
